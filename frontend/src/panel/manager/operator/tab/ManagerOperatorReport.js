...
const ManagerOperatorReport = (operatorId) => {
    ...
    const getOperatorReport = () => {
        if (startDate !== undefined && endDate !== undefined && startDate <= endDate) {
            return api.post("http://localhost:8080/api/report/operator/get", {employeeId: operatorId.operatorId,
...
export default ManagerOperatorReport;